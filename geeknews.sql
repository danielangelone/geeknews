...
INSERT INTO `tblcategoria` (`id`, `CategoryName`, `Description`, `PostingDate`, `UpdationDate`, `Is_Active`) VALUES
(3, 'CodeWave', 'Tendências em Desenvolvimento de Software', '2021-06-05 18:30:00', '2021-06-13 18:30:00', 1),
(5, 'AIBeyond', 'Inovações em Inteligência Artificial e Machine Learning', '2021-06-13 18:30:00', '2021-06-13 18:30:00', 1),
(6, 'SecureVerse', 'Segurança Cibernética e Privacidade', '2021-06-21 18:30:00', '0000-00-00 00:00:00', 1),
(7, 'Business', 'Desenvolvimento Web e Mobile', '2021-06-21 18:30:00', '0000-00-00 00:00:00', 1),
(8, 'TechSphere', 'Gadgets e Inovações Tecnológicas', '2021-11-07 18:17:28', NULL, 1);
...
INSERT INTO `tblcomentarios` (`id`, `postId`, `name`, `email`, `comment`, `postingDate`, `status`) VALUES
...
(1, 'sobre', 'Sobre o GeekNews', '<font color=\"#7b8898\" face=\"Mercury SSm A, Mercury SSm B, Georgia, Times, Times New Roman, Microsoft YaHei New, Microsoft Yahei, å¾®è½¯é›…é»‘, å®‹ä½“, SimSun, STXihei, åŽæ–‡ç»†é»‘, serif\"><span style=\"font-size: 26px;\">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span></font><br>', '2021-06-29 18:30:00', '2021-11-06 18:30:00'),
(2, 'contato', 'Entre em Contato', '<p><br></p><p><b>Address :&nbsp; </b>Brasil</p><p><b>Phone Number : </b>+55 -1999999999</p><p><b>Email -id : </b>geeknews@gmail.com</p>', '2021-06-29 18:30:00', '2021-11-06 18:30:00');
...
CREATE TABLE `tblposts` (
  `id` int(11) NOT NULL,
  `PostTitulo` longtext DEFAULT NULL,
...
INSERT INTO `tblposts` (`id`, `PostTitulo`, `CategoriaId`, `SubCategoriaId`, `PostDetails`, `PostingDate`, `UpdationDate`, `Is_Active`, `PostUrl`, `PostImage`, `viewCounter`, `postedBy`, `lastUpdatedBy`) VALUES
...
INSERT INTO `tblsubcategoria` (`SubCategoriaId`, `CategoriaId`, `Subcategoria`, `SubCatDescription`, `PostingDate`, `UpdationDate`, `Is_Active`) VALUES
(3, 5, 'MicroFrameworks ', 'Tendências em Desenvolvimento de Software', '2021-06-21 18:30:00', '2021-11-07 17:59:57', 1),
(4, 3, 'DeepLearningInsights', 'Inovações em Inteligência Artificial e Machine Learning', '2021-06-29 18:30:00', '2021-11-07 17:59:57', 1),
(5, 3, 'PrivacyGuardians', 'Segurança Cibernética e Privacidade', '2021-06-29 18:30:00', '2021-11-07 17:59:57', 1),
(6, 5, 'Television', 'Desenvolvimento Web e Mobile', '2021-06-30 18:30:00', '2021-11-07 17:59:57', 1),
(7, 6, 'MobileCraftsmanship', 'Desenvolvimento Web e Mobile', '2021-06-30 18:30:00', '2021-11-07 17:59:57', 1),
(8, 6, 'InnovativeGizmos', 'Gadgets e Inovações Tecnológicas', '2021-06-30 18:30:00', '2021-11-07 17:59:57', 1),
(9, 7, 'TechLaughs', 'Humor Geek e Tecnológico', '2021-06-30 18:30:00', '2021-11-07 17:59:57', 1),
(10, 8, 'InnovativeGizmos', 'Gadgets e Inovações Tecnológicas', '2021-11-07 18:18:25', NULL, 1);
...
ALTER TABLE `tblposts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`),
  ADD KEY `postcatid` (`CategoriaId`),
  ADD KEY `postsucatid` (`SubCategoriaId`),
  ADD KEY `subadmin` (`postedBy`);

--
-- Indexes for table `tblsubcategoria`
--
ALTER TABLE `tblsubcategoria`
  ADD PRIMARY KEY (`SubCategoriaId`),
  ADD KEY `catid` (`CategoriaId`);
...
--
-- AUTO_INCREMENT for table `tblsubcategoria`
--
ALTER TABLE `tblsubcategoria`
  MODIFY `SubCategoriaId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tblposts`
  ADD CONSTRAINT `postcatid` FOREIGN KEY (`CategoriaId`) REFERENCES `tblcategoria` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `postsucatid` FOREIGN KEY (`SubCategoriaId`) REFERENCES `tblsubcategoria` (`SubCategoriaId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `subadmin` FOREIGN KEY (`postedBy`) REFERENCES `tbladmin` (`AdminUserName`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `tblsubcategoria`
--
ALTER TABLE `tblsubcategoria`
  ADD CONSTRAINT `catid` FOREIGN KEY (`CategoriaId`) REFERENCES `tblcategoria` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
