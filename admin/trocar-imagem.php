...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select PostImage,PostTitulo from tblposts where id='$postid' and Is_Active=1 ");
...
<input type="text" class="form-control" id="posttitle" value="<?php echo htmlentities($row['PostTitulo']);?>" name="posttitle"  readonly>
</div>
