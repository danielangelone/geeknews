...
<html lang="en">
    <head>
        ...
        <title>GEEK NEWS | Sub-Admin</title>
...
<form class="form-horizontal" name="addsuadmin" method="post">
       ...
       <label for="exampleInputusername">Login</label>
               <input type="text" placeholder="login"  name="sadminusername" id="sadminusername" class="form-control" pattern="^[a-zA-Z][a-zA-Z0-9-_.]{5,12}$" title="Username must be alphanumeric 6 to 12 chars" onBlur="checkAvailability()"  required>
    ...
    <div class="form-group">
     <label for="password">Senha</label>
      <input type="password" class="form-control" id="pwd" name="pwd" placeholder="Senha" required>
</div>
