...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Geek News | Portal Administrativo</title>
...
<a href="reset-senha.php"><i class="mdi mdi-lock"></i> Reset de senha</a>
<hr>
                                        <div class="form-group">
                                            <div class="col-xs-12">
...
<a href="../index.php"><i class="mdi mdi-home"></i> Voltar</a>
                                </div>
                            </div>
                            <!-- end card-box-->
