...
$query=mysqli_query($con,"update tblsubcategoria set CategoriaId='$categoryid',Subcategoria='$subcatname',SubCatDescription='$subcatdescription' where SubCategoriaId='$subcatid'");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>GEEKNEWS | Edit Sub Category</title>
...
$subcatid=intval($_GET['scid']);
$query=mysqli_query($con,"Select tblcategoria.CategoryName as catname,tblcategoria.id as catid,tblsubcategoria.Subcategoria as subcatname,tblsubcategoria.SubCatDescription as SubCatDescription,tblsubcategoria.PostingDate as subcatpostingdate,tblsubcategoria.UpdationDate as subcatupdationdate,tblsubcategoria.SubCategoriaId as subcatid from tblsubcategoria join tblcategoria on tblsubcategoria.CategoriaId=tblcategoria.id where tblsubcategoria.Is_Active=1 and  SubCategoriaId='$subcatid'");
$cnt=1;
...
<?php } ?>
    ...
    <div class="form-group">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Sub-Descrição</label>
	                                                <div class="col-md-10">
